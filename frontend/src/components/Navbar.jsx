  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[#0A0E17]/85 border-b border-[#1F2D47]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 h-20 flex items-center justify-between">
        <Link to="/" data-testid="nav-brand-logo" className="flex items-baseline gap-2 group">
          <span className="font-serif text-2xl tracking-tight text-[#F9FAFB]">
            Nivi <span className="italic text-[#E2C08D]">Finserv</span>
          </span>
